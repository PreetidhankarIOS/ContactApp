//
//  PKBallRotateChaseAnimation.swift
//
...
class PKBallRotateChaseAnimation: PKIndicatorAnimationDelegate {
    func setUpAnimation(in view: UIView, size: CGSize, color: UIColor) {
        ...
        for i in 0 ..< 5 {
            ...
            let circle = PKIndicatorShape.circle.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
