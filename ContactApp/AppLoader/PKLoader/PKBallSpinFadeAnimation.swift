...
class PKBallSpinFadeAnimation: PKIndicatorAnimationDelegate {
    ...
    func circleAt(angle: CGFloat, size: CGFloat, origin: CGPoint, containerSize: CGSize, color: UIColor) -> CALayer {
        ...
        let circle = PKIndicatorShape.circle.layerWith(size: CGSize(width: size, height: size), color: color)
        let frame = CGRect(
