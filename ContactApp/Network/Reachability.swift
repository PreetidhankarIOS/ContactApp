...
//
//
//  Created by Pawan Kumar on 14/07/17.
...
/**********************************
 ...
 Will help to get weather device
 have the internet connectivity or not.
...
class Reachability: NSObject {
    ...
    func startNotifier() -> Bool {
        ...
        guard let reachability = networkReachability, SCNetworkReachabilitySetCallback(reachability, { (_: SCNetworkReachability, _: SCNetworkReachabilityFlags, info: UnsafeMutableRawPointer?) in
